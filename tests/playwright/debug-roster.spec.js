...
test.describe('Umamusume Roster Debug', () => {
    test('debug what is actually on the page', async ({ page }) => {
        ...
        await page.screenshot({ path: 'debug-characters-page.png', fullPage: true });
        ...
        const errorMessage = await page.locator('.alert-danger, .alert-warning').textContent().catch(() => 'No error found');
