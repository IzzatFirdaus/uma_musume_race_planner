...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="{{ route('dashboard') }}">
            <img src="{{ asset('uploads/app_logo/uma_musume_race_planner_logo_64.ico') }}" alt="Uma Musume Logo" class="logo">
            <span class="ms-2 fw-bold">Uma Musume: Pretty Derby Planner</span>
        </a>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-glass">
                        <li><a class="dropdown-item" href="https://umamusume.wiki/Game:Mechanics" target="_blank">Game Mechanics</a></li>
