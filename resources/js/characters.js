document.addEventListener("DOMContentLoaded", function () {
    ...
    function generateCharacterDetailHTML(character) {
        ...
        const avatarPath = character.images?.avatar
            ? `${base}/${String(character.images.avatar).replace(/^\/+/, "")}`
            : `${base}/uploads/app_logo/uma_musume_race_planner_logo_64.ico`;
        return `
            <div class="row">
