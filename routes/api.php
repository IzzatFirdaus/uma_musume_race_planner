...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    Route::post('plans/quick', [PlanController::class, 'storeQuick'])->name('plans.storeQuick');
    Route::get('plans/{plan}/progress-chart', [PlanController::class, 'progressChart'])->name('plans.progressChart');

    // Route for the autosuggest functionality
    Route::get('autosuggest', [AutosuggestController::class, 'index'])->name('autosuggest');
