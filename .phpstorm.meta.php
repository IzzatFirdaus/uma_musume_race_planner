...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.theme_color' => 'string',
            'app.version' => 'string',
            'app.last_updated' => 'string',
            ...
            'cache.stores.null.driver' => 'string',
            ...
            'filesystems.links.C:\XAMPP\htdocs\uma-musume-planner-laravel\public\storage' => 'string',
...
'app.aliases.Vite','app.theme_color','app.version','app.last_updated','auth.defaults.guard',
...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.stores.null.driver','cache.stores.|-microscope-|.driver','cache.stores.|-microscope-|.path',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\XAMPP\\htdocs\\uma-musume-planner-laravel\\public\\storage','insights.preset','insights.ide',
'insights.exclude','insights.add.NunoMaduro\\PhpInsights\\Domain\\Metrics\\Architecture\\Classes','insights.remove','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title','insights.requirements',
...
'boost.browser_logs_watcher','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'boost.browser-logs','livewire.update','livewire.upload-file',
'livewire.preview-file','api.v1.plans.index','api.v1.plans.store','api.v1.plans.show','api.v1.plans.update',
'api.v1.plans.destroy','api.v1.plans.storeQuick','api.v1.plans.progressChart','api.v1.autosuggest','api.v1.dashboard.stats',
'api.v1.dashboard.activities','dashboard','guide','storage.local',);
        registerArgumentsSet('views', 
'dashboard','dashboard.partials.header-banner','dashboard.partials.plan-inline-details','dashboard.partials.plan-list','dashboard.partials.recent-activity',
'dashboard.partials.stats-panel','guide','layouts.app','layouts.partials.footer','layouts.partials.navbar',
'livewire.dashboard.header-banner','livewire.dashboard.plan-inline-details','livewire.dashboard.plan-list','livewire.dashboard.recent-activity','livewire.dashboard.stats-panel',
'livewire.form-tabs','livewire.layout.footer','livewire.layout.navbar','livewire.plan-details','livewire.quick-create-plan',
'livewire.trainee-image-handler','modals.plan-details','modals.quick-create-plan','plans.partials.copy-script','plans.partials.form-tabs',
'plans.partials.trainee-image-handler','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'livewire::tailwind','microscope_package::actions_comment','notifications::email','pagination::bootstrap-4','pagination::bootstrap-5',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_VERSION','APP_THEME_COLOR',
'LAST_UPDATED','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL',
